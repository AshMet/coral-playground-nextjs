  ...
  return (
    <Card height="max-content" {...rest}>
      ...
      <SimpleGrid columns="3" mb="40px" gap="8px">
        <Link href="#">{/* <Image borderRadius='8px' src={image1} /> */}</Link>
        <Link href="#">{/* <Image borderRadius='8px' src={image2} /> */}</Link>
        <Link href="#">{/* <Image borderRadius='8px' src={image3} /> */}</Link>
        <Link href="#">{/* <Image borderRadius='8px' src={image4} /> */}</Link>
        <Link href="#">{/* <Image borderRadius='8px' src={image5} /> */}</Link>
        <Link href="#">{/* <Image borderRadius='8px' src={image6} /> */}</Link>
      </SimpleGrid>
      <Text fontSize="lg" color={textColor} fontWeight="700" mb="20px">
        Suggestions for you
      </Text>
