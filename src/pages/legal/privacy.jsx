        ...
        >
          ...
          >
            ...
            <Text
              ...
              mb="45px"
            >
              Thank you for choosing to be part of our community at Coral
              Playground Web LLC (&quot;
            ...
            >
              ...
              &quot;Services&quot;, which include the Website ), we appreciate
              ...
              <ListItem color="#878CBD">
                <Text fontSize="lg" lineHeight="38px" fontWeight="400" mb="0px">
                  ...
                  <Text
                    ...
                    mx="3px"
                  >
                    https://coralplayground.com/contact
                  </Text>
                  {/* </NavLink> */}
            ...
            <Text
              ...
              mb="45px"
            >
              You may contact us by visiting {/* <NavLink to="/contact"> */}
              <Text
                textDecoration="underline"
                color="brand.300"
                fontWeight="500"
              ...
              {/* </NavLink> */}, or by referring to the contact details at the
            ...
            <Text
              ...
              mb="45px"
            >
              Coral Playground Web LLC has not disclosed or sold any personal
              information to third parties for a business or commercial purpose
              in the preceding 12 months. Coral Playground Web LLC will not sell
            ...
            <Text
              ...
              mb="45px"
            >
              Coral Playground Web LLC, Str. Matei Voievod 103-113, Bloc O3,
              Scara 3, Ap.123, Bucharest,021453 Romania
            </Text>
            {/* 14. */}
            <Text
              id="12"
            ...
            <Text color="#878CBD" fontSize="lg" lineHeight="34px" mb="45px">
              ...
              {/* </NavLink> */}. We will respond to your request within 30
              days.
            </Text>
            <HSeparator w="100%" mb="40px" mx="auto" />
            <Text
              ...
              mx="auto"
            >
              Got a question? {/* <NavLink to="/contact"> */}
              <Text
                textDecoration="underline"
                color="brand.300"
                fontWeight="500"
