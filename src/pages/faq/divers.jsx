...
import faqs from "lib/constants/diverFaqInputs.json";

export default function DiverFAQ() {
          ...
          <Box textAlign={{ lg: "center" }}>
            ...
            >
              ...
              <Button
                ...
                onClick={() => router.push("/faq/dive_centres")}
              >
                <Text fontWeight="500" color="brand.300">
                  Dive Centres
                </Text>
...
DiverFAQ.getLayout = function getLayout(page) {
